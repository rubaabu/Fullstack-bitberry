...
$sql = "UPDATE news SET news_title ='$news_title', news_info='$news_info', news_status='$news_status', news_created_by='$news_created_by', news_created_at='$news_created_at', news_updated_by='$news_updated_by' WHERE news_id={$data->news_id}";
