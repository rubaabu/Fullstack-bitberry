...
class Form extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
        title:props.news.news_title,
        info:props.news.news_info,
        status:props.news.news_status,
        created_by:props.news.news_created_by,
        created_at:props.news.news_created_at,
        updated_by:props.news.news_updated_by
    };
    console.log("first state", this.state.info)
  }
