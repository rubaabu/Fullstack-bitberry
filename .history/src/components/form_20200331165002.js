      ...
      <div>
        <form onSubmit={this.handleSubmit}>
          ...
          <select onChange={this.handleInputStatus}>
            <option  onChange={this.handleInputStatus} value="">-</option>
            <option onChange={this.handleInputStatus} value={this.state.status}>Open</option>
            <option onChange={this.handleInputStatus} value={this.state.status}>Closed</option>
          </select>
